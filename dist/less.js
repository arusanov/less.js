;(function(global, factory) {
  ...
  var Environment = (function() {
    ...
    Environment.prototype.getFileManager = function getFileManager(
      filename,
      currentDirectory,
      options,
      environment,
    ...
    Environment.prototype.addFileManager = function addFileManager(
      fileManager
    ) {
  ...
  var sourceMapOutput = function sourceMapOutput(environment) {
    var SourceMapOutput = (function() {
      ...
      SourceMapOutput.prototype.normalizeFilename = function normalizeFilename(
        filename
      ) {
      ...
      SourceMapOutput.prototype.add = function add(
        chunk,
        fileInfo,
        index,
        mapLines
  ...
  var sourceMapBuilder = function sourceMapBuilder(
    ...
    var SourceMapBuilder = (function() {
      ...
      SourceMapBuilder.prototype.toCSS = function toCSS(
        rootNode,
        options,
        imports
      ) {
      ...
      SourceMapBuilder.prototype.setExternalSourceMap = function setExternalSourceMap(
        sourceMap
      ) {
 ...
 */
  ...
  var Selector = (function(_Node) {
    ...
    Selector.prototype.createDerived = function createDerived(
      elements,
      extendList,
      evaldCondition
    ) {
  ...
  var Ruleset = (function(_Node) {
    ...
    Ruleset.prototype.eval = function _eval(context) {
      ...
      for (i = 0; i < rsRules.length; i++) {
        ...
        if (
          rule$$1 instanceof Ruleset &&
          rule$$1.selectors &&
          rule$$1.selectors.length === 1
        ) {
    ...
    Ruleset.prototype.matchCondition = function matchCondition(args, context) {
      ...
      if (
        ...
        !lastSelector.condition.eval(
          new contexts_1.Eval(context, context.frames)
        )
      ) {
        return false
      }
            ...
            if (match) {
              if (selector$$1.elements.length > match) {
                if (!filter || filter(rule$$1)) {
                  foundMixins = rule$$1.find(
                    new selector(selector$$1.elements.slice(match)),
                    self,
                    filter
                  )
    ...
    Ruleset.prototype.joinSelectors = function joinSelectors(
      paths,
      context,
      selectors
    ) {
    ...
    Ruleset.prototype.joinSelector = function joinSelector(
      paths,
      context,
      selector$$1
    ) {
        ...
        if (context.length > 0) {
          ...
          for (i = 0; i < context.length; i++) {
            ...
            var concatenated = context[i].map(
              deriveSelector.bind(this, selector$$1.visibilityInfo())
            )
  ...
  var Directive = (function(_Node) {
    ...
    Directive.prototype.outputRuleset = function outputRuleset(
      context,
      output,
      rules
    ) {
  ...
  var DetachedRuleset = (function(_Node) {
    ...
    DetachedRuleset.prototype.callEval = function callEval(context) {
      return this.ruleset.eval(
        this.frames
          ? new contexts_1.Eval(context, this.frames.concat(context.frames))
          : context
      )
    }
  ...
  var Dimension = (function(_Node) {
    ...
    function Dimension(value, unit$$1) {
      ...
      _this.unit =
        unit$$1 && unit$$1 instanceof unit
          ? unit$$1
          : new unit(unit$$1 ? [unit$$1] : undefined)
      return _this
    }
    ...
    Dimension.prototype.operate = function operate(context, op, other) {
      ...
      if (op === '+' || op === '-') {
        if (
          unit$$1.numerator.length === 0 &&
          unit$$1.denominator.length === 0
        ) {
          ...
          if (
            context.strictUnits &&
            other.unit.toString() !== unit$$1.toString()
          ) {
            throw new Error(
        ...
        unit$$1.numerator = unit$$1.numerator
          .concat(other.unit.numerator)
          .sort()
        unit$$1.denominator = unit$$1.denominator
  ...
  var Quoted = (function(_JsEvalNode) {
    ...
    Quoted.prototype.eval = function _eval(context) {
      ...
      var interpolationReplacement = function interpolationReplacement(
        _,
        name
      ) {
        var v = new variable('@' + name, that.index, that.currentFileInfo).eval(
          context,
          true
        )
  ...
  var Call = (function(_Node) {
    ...
    Call.prototype.eval = function _eval(context) {
      ...
      var result = void 0
      var funcCaller = new functionCaller_1(
        this.name,
        context,
        this.index,
        this.currentFileInfo
  ...
  var Import = (function(_Node) {
    ...
    Import.prototype.doEval = function doEval(context) {
      ...
      if (this.options.inline) {
        ...
        return this.features
          ? new media(ruleset$$1.rules, this.features.value)
          : ruleset$$1.rules
      }
    }
  ...
  var Definition = (function(_Ruleset) {
    ...
    function Definition(
      ...
      _this.selectors = [
        new selector([
          new element(null, name, _this.index, _this.currentFileInfo),
        ]),
      ]
      _this.params = params
      _this.condition = condition
    ...
    Definition.prototype.evalParams = function evalParams(
      context,
      mixinEnv,
      args,
      evaldArguments
    ...
    Definition.prototype.evalCall = function evalCall(
      context,
      args,
      important
    ) {
      ...
      var frame = this.evalParams(
        context,
        new contexts_1.Eval(context, mixinFrames),
        args,
        _arguments
      )
      var rules = void 0
      ...
      ruleset$$1 = ruleset$$1.eval(
        new contexts_1.Eval(context, [this, frame].concat(mixinFrames))
      )
      if (important) {
    ...
    Definition.prototype.matchCondition = function matchCondition(
      args,
      context
    ) {
      if (
  ...
  var MixinCall = (function(_Node) {
    ...
    MixinCall.prototype._setVisibilityToReplacement = function _setVisibilityToReplacement(
      replacement
    ) {
      var i = void 0
      var rule = void 0
  ...
  var ImportSequencer = (function() {
    ...
    ImportSequencer.prototype.addVariableImport = function addVariableImport(
      callback
    ) {
  ...
  ImportVisitor.prototype = {
    ...
    visitImport: function visitImport(importNode, visitArgs) {
      ...
      if (!importNode.css || inlineCSS) {
        var context = new contexts_1.Eval(
          this.context,
    ...
    processImportNode: function processImportNode(
      importNode,
      context,
      importParent
    ) {
    ...
    visitMixinDefinition: function visitMixinDefinition(
      mixinDefinitionNode,
      visitArgs
    ) {
  ...
  var ExtendFinderVisitor = (function() {
    ...
    ExtendFinderVisitor.prototype.visitRule = function visitRule(
      ruleNode,
      visitArgs
    ) {
      visitArgs.visitDeeper = false
    ...
    ExtendFinderVisitor.prototype.visitMixinDefinition = function visitMixinDefinition(
      mixinDefinitionNode,
      visitArgs
    ) {
      visitArgs.visitDeeper = false
    ...
    ExtendFinderVisitor.prototype.visitRuleset = function visitRuleset(
      rulesetNode,
      visitArgs
    ) {
      if (rulesetNode.root) {
    ...
    ExtendFinderVisitor.prototype.visitRulesetOut = function visitRulesetOut(
      rulesetNode
    ) {
      if (!rulesetNode.root) {
    ...
    ExtendFinderVisitor.prototype.visitMedia = function visitMedia(
      mediaNode,
      visitArgs
    ) {
    ...
    ExtendFinderVisitor.prototype.visitMediaOut = function visitMediaOut(
      mediaNode
    ) {
      this.allExtendsStack.length = this.allExtendsStack.length - 1
    }

    ExtendFinderVisitor.prototype.visitDirective = function visitDirective(
      directiveNode,
      visitArgs
    ) {
    ...
    ExtendFinderVisitor.prototype.visitDirectiveOut = function visitDirectiveOut(
      directiveNode
    ) {
      this.allExtendsStack.length = this.allExtendsStack.length - 1
    }
  ...
  var ProcessExtendsVisitor = (function() {
    ...
    ProcessExtendsVisitor.prototype.checkExtendsForNonMatched = function checkExtendsForNonMatched(
      extendList
    ) {
    ...
    ProcessExtendsVisitor.prototype.doExtendChaining = function doExtendChaining(
      extendsList,
      extendsListTarget,
      iterationCount
    ) {
    ...
    ProcessExtendsVisitor.prototype.visitRule = function visitRule(
      ruleNode,
      visitArgs
    ) {
      visitArgs.visitDeeper = false
    ...
    ProcessExtendsVisitor.prototype.visitMixinDefinition = function visitMixinDefinition(
      mixinDefinitionNode,
      visitArgs
    ) {
      visitArgs.visitDeeper = false
    ...
    ProcessExtendsVisitor.prototype.visitSelector = function visitSelector(
      selectorNode,
      visitArgs
    ) {
      visitArgs.visitDeeper = false
    ...
    ProcessExtendsVisitor.prototype.visitRuleset = function visitRuleset(
      rulesetNode,
      visitArgs
    ) {
      if (rulesetNode.root) {
    ...
    ProcessExtendsVisitor.prototype.findMatch = function findMatch(
      extend,
    ...
    ProcessExtendsVisitor.prototype.isElementValuesEqual = function isElementValuesEqual(
      elementValue1,
      elementValue2
    ) {
      if (
      ...
      if (elementValue1 instanceof index$6.Selector) {
        if (
          !(elementValue2 instanceof index$6.Selector) ||
    ...
    ProcessExtendsVisitor.prototype.extendSelector = function extendSelector(
      matches,
      selectorPath,
      replacementSelector,
      isVisible
      ...
      for (matchIndex = 0; matchIndex < matches.length; matchIndex++) {
        ...
        firstElement = new index$6.Element(
    ...
    ProcessExtendsVisitor.prototype.visitMedia = function visitMedia(
      mediaNode,
      visitArgs
    ) {
    ...
    ProcessExtendsVisitor.prototype.visitMediaOut = function visitMediaOut(
      mediaNode
    ) {
    ...
    ProcessExtendsVisitor.prototype.visitDirective = function visitDirective(
      directiveNode,
      visitArgs
    ) {
    ...
    ProcessExtendsVisitor.prototype.visitDirectiveOut = function visitDirectiveOut(
      directiveNode
    ) {
      var lastIndex = this.allExtendsStack.length - 1
      this.allExtendsStack.length = lastIndex
  ...
  var JoinSelectorVisitor = (function() {
    ...
    JoinSelectorVisitor.prototype.visitRule = function visitRule(
      ruleNode,
      visitArgs
    ) {
      visitArgs.visitDeeper = false
    ...
    JoinSelectorVisitor.prototype.visitMixinDefinition = function visitMixinDefinition(
      mixinDefinitionNode,
      visitArgs
    ) {
      visitArgs.visitDeeper = false
    ...
    JoinSelectorVisitor.prototype.visitRuleset = function visitRuleset(
      rulesetNode,
      visitArgs
    ) {
    ...
    JoinSelectorVisitor.prototype.visitRulesetOut = function visitRulesetOut(
      rulesetNode
    ) {
      this.contexts.length = this.contexts.length - 1
    }

    JoinSelectorVisitor.prototype.visitMedia = function visitMedia(
      mediaNode,
      visitArgs
    ) {
      var context = this.contexts[this.contexts.length - 1]
    ...
    JoinSelectorVisitor.prototype.visitDirective = function visitDirective(
      directiveNode,
      visitArgs
    ) {
      var context = this.contexts[this.contexts.length - 1]
  ...
  var CSSVisitorUtils = (function() {
    ...
    CSSVisitorUtils.prototype.containsSilentNonBlockedChild = function containsSilentNonBlockedChild(
      bodyRules
    ) {
      var rule = void 0
      if (bodyRules == null) {
    ...
    CSSVisitorUtils.prototype.keepOnlyVisibleChilds = function keepOnlyVisibleChilds(
      owner
    ) {
    ...
    CSSVisitorUtils.prototype.hasVisibleSelector = function hasVisibleSelector(
      rulesetNode
    ) {
    ...
    CSSVisitorUtils.prototype.resolveVisibility = function resolveVisibility(
      node,
      originalRules
    ) {
    ...
    CSSVisitorUtils.prototype.isVisibleRuleset = function isVisibleRuleset(
      rulesetNode
    ) {
  ...
  ToCSSVisitor.prototype = {
    ...
    visitDirectiveWithBody: function visitDirectiveWithBody(
      directiveNode,
      visitArgs
    ) {
    ...
    visitDirectiveWithoutBody: function visitDirectiveWithoutBody(
      directiveNode,
      visitArgs
    ) {
      ...
      if (directiveNode.name === '@charset') {
        ...
        if (this.charset) {
          if (directiveNode.debugInfo) {
            var comment = new index$6.Comment(
              '/* ' +
  ...
  var transformTree = function transformTree(root, options) {
    ...
    //
    if (
      (typeof variables === 'undefined' ? 'undefined' : _typeof(variables)) ===
        'object' &&
    ...
    var visitors = [
      new index$4.JoinSelectorVisitor(),
      new index$4.MarkVisibleSelectorsVisitor(true),
      new index$4.ExtendVisitor(),
      new index$4.ToCSSVisitor({
  ...
  var Parser = function Parser(context, imports, fileInfo) {
    ...
    function expect(arg, msg, index) {
      ...
      var result =
        arg instanceof Function ? arg.call(parsers) : parserInput$$1.$re(arg)
      if (result) {
        return result
      }
      error(
    ...
    function expectChar(arg, msg) {
      ...
      error(
        msg ||
          "expected '" + arg + "' got '" + parserInput$$1.currentChar() + "'"
      )
    }
    ...
    function getDebugInfo(index) {
      ...
      return {
        lineNumber:
          utils.getLocation(index, parserInput$$1.getInput()).line + 1,
        fileName: filename,
      }
    }
    ...
    return {
      ...
      parse: function parse(str, callback, additionalData) {
        ...
        try {
          parserInput$$1.start(str, context.chunkInput, function fail(
            msg,
            index
          ) {
            throw new lessError(
      ...
      parsers: (parsers = {
        ...
        entities: {
          ...
          keyword: function keyword() {
            var k =
              parserInput$$1.$char('%') ||
              parserInput$$1.$re(/^[_A-Za-z-][_A-Za-z0-9-]*/)
            if (k) {
          ...
          url: function url() {
            ...
            return new index$6.URL(
              value.value != null || value instanceof index$6.Variable
                ? value
                : new index$6.Anonymous(value),
              index,
              fileInfo
            )
          },
          ...
          color: function color() {
            ...
            if (
              parserInput$$1.currentChar() === '#' &&
              (rgb = parserInput$$1.$re(/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})/))
            ) {
        ...
        extend: function extend(isRule) {
          ...
          do {
            ...
            extend = new index$6.Extend(
              new index$6.Selector(elements),
              option,
              index,
              fileInfo
            )
        ...
        mixin: {
          ...
          definition: function definition() {
            ...
            if (match) {
              ...
              if (ruleset) {
                parserInput$$1.forget()
                return new index$6.mixin.Definition(
                  name,
                  params,
                  ruleset,
                  cond,
        ...
        selector: function selector(isLess) {
          ...
          while (
            ...
            (isLess && (when = parserInput$$1.$str('when'))) ||
            (e = this.element())
          ) {
            if (when) {
        ...
        ruleset: function ruleset() {
          ...
          if (selectors && (rules = this.block())) {
            parserInput$$1.forget()
            var ruleset = new index$6.Ruleset(
              selectors,
              rules,
        ...
        multiplication: function multiplication() {
          ...
          if (m) {
            ...
            while (true) {
              ...
              m.parensInOp = true
              a.parensInOp = true
              operation = new index$6.Operation(
                op,
                [operation || m, a],
                isSpaced
              )
          ...
          if (m) {
            ...
            while (true) {
              op =
                parserInput$$1.$re(/^[-+]\s+/) ||
                (!isSpaced &&
                  (parserInput$$1.$char('+') || parserInput$$1.$char('-')))
              if (!op) {
                break
              }
        ...
        parenthesisCondition: function parenthesisCondition() {
          ...
          if (!parserInput$$1.$char(')')) {
            parserInput$$1.restore(
              "expected ')' got '" + parserInput$$1.currentChar() + "'"
            )
            return
          }
          parserInput$$1.forget()
        ...
        atomicCondition: function atomicCondition() {
          ...
          if (a) {
            ...
            if (op) {
              ...
              c = new index$6.Condition(
                '=',
                a,
                new index$6.Keyword('true'),
                index,
                false
              )
            }
        ...
        ruleProperty: function ruleProperty() {
          ...
          if (name.length > 1 && match(/^((?:\+_|\+)?)\s*:/)) {
            ...
            for (k = 0; k < name.length; k++) {
              ...
              name[k] =
                s.charAt(0) !== '@'
                  ? new index$6.Keyword(s)
                  : new index$6.Variable(
                      '@' + s.slice(2, -1),
                      index[k],
                      fileInfo
                    )
  ...
  var importManager = function importManager(environment) {
    ...
    var ImportManager = (function() {
      ...
      ImportManager.prototype.push = function push(
        path,
        tryAppendLessExtension,
        currentFileInfo,
        importOptions,
        ...
        var loadFileCallback = function loadFileCallback(loadedFile) {
          ...
          if (importOptions.plugin) {
            new functionImporter(newEnv, newFileInfo).eval(contents, function(
              e,
              root
            ) {
  ...
  var abstractFileManager = (function() {
    ...
    abstractFileManager.prototype.tryAppendExtension = function tryAppendExtension(
      path,
      ext
    ) {
    ...
    abstractFileManager.prototype.tryAppendLessExtension = function tryAppendLessExtension(
      path
    ) {
    ...
    abstractFileManager.prototype.isPathAbsolute = function isPathAbsolute(
      filename
    ) {
  ...
  colorFunctions = {
    ...
    luminance: function luminance(color$$1) {
      var luminance =
        0.2126 * color$$1.rgb[0] / 255 +
        0.7152 * color$$1.rgb[1] / 255 +
        0.0722 * color$$1.rgb[2] / 255
  ...
  for (var f$1 in mathFunctions) {
    if (mathFunctions.hasOwnProperty(f$1)) {
      mathFunctions[f$1] = mathHelper._math.bind(
        null,
        Math[f$1],
        mathFunctions[f$1]
      )
 ...
 */
  var PluginManager = (function() {
    ...
    PluginManager.prototype.addPreProcessor = function addPreProcessor(
      preProcessor,
      priority
    ) {
    ...
    PluginManager.prototype.addPostProcessor = function addPostProcessor(
      postProcessor,
      priority
    ) {
      var indexToInsertAt = void 0
  ...
  var less = index$2({}, [new NotSupportedFileManager()])
